...
<body>
   ...
   <footer> 
      <div>
         <a class = "foot-a first not_hover_stl" style ="font-weight:bold; color : gray;">Eagle's Auction</a>
         <a class = "foot-a not_hover_stl" >제휴문의</a> <p class = "not_hover_stl"> | <p>
         <a class = "foot-a not_hover_stl" >개인정보 취급방침  </a> <p class = "not_hover_stl"> | <p>
          <a class = "foot-a not_hover_stl" id = "customer_center" > 고객센터</a>  <p class = "not_hover_stl"> |  <p>
          <a class = "foot-a not_hover_stl" >이용약관 </a>
