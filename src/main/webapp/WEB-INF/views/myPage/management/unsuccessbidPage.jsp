...
<body>
	...
	<div class="tabBigBox btab_2ea mt40" style="margin-left: auto; margin-right: auto; width: 1500px; padding-top: 100px; padding-bottom: 50px;">
				...
				<ul>
					<li style="width:25%"><a href="purchaseend.mp">낙찰받은 물품</a></li>
					<li class="on" style="width:25%"><a href="unsuccessbid.mp">낙찰받지 못한 물품</a></li>
				</ul>
	</div>

	     <h5 class="content">낙찰 받지 못한 물품에 대해서 모두 ${ fn:length(list) }개가 검색되었습니다.</h5>
