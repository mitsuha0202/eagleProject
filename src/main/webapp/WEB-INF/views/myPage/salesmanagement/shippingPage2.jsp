...
<!-- 헤더바 -->
	...
	<div class="tabBigBox btab_2ea mt40" style="margin-left: auto; margin-right: auto; width: 1500px; padding-top: 100px; padding-bottom: 50px;">
				...
				<ul>
					...
					<li class="on" style="width:20%"><a href="shipping2.mp">배송중</a></li>
	...
	<div id="pagingArea" class="numbox mt50">
         ...
         <c:if test="${ pi.currentPage > 1 }">
            <c:url var="blistBack" value="shipping2.mp">
         ...
         <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
            ...
            <c:if test="${ p ne pi.currentPage }">
               <c:url var="blistCheck" value="shipping2.mp">
         ...
         <c:if test="${ pi.currentPage < pi.maxPage }">
            <c:url var="blistEnd" value="shipping2.mp">
               <c:param name="currentPage" value="${ pi.currentPage + 1}"/>
            </c:url>
