...
<body>
	...
	<div class="tabBigBox btab_2ea mt40" style="margin-left: auto; margin-right: auto; width: 1500px; padding-top: 100px; padding-bottom: 50px;">
				<ul style="padding-bottom: 100px;">
					...
					<li class="on" style="width:25%"><a href="salesother.mp">구매거부/반품/미입금/판매거부/미수령신고</a></li>
				</ul>
				<ul>
					<li style="width:20%"><a href="salesother.mp">구매거부</a></li>
					<li class="on" style="width:20%"><a href="return2.mp">반품</a></li>
					<li style="width:20%"><a href="payment2.mp">미입금</a></li>
					<li style="width:20%"><a href="refusetosell2.mp">판매거부</a></li>
					<li style="width:20%"><a href="notreceving2.mp">미수령신고</a></li>
				</ul>
		</div>
		
	     <h5 class="content">반품 물품에 대해서 모두 ${ fn:length(list) }개가 검색되었습니다.</h5>
    ...
    <div class="btnArea">
    	<button id="dealBtn" class="ui black basic button" data-toggle="modal" data-target="#exampleModal">반품물품 수령</button>
	</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">반품된 물품을 받으셨습니까?</h5>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary" onclick="returnFinish();">확인</button>
	      </div>
	    </div>
	  </div>
	</div>
	...
	<div id="pagingArea" class="numbox mt50">
         ...
         <c:if test="${ pi.currentPage > 1 }">
            <c:url var="blistBack" value="return2.mp">
         ...
         <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
            ...
            <c:if test="${ p ne pi.currentPage }">
               <c:url var="blistCheck" value="return2.mp">
         ...
         <c:if test="${ pi.currentPage < pi.maxPage }">
            <c:url var="blistEnd" value="return2.mp">
               <c:param name="currentPage" value="${ pi.currentPage + 1}"/>
            </c:url>
